...
The list of users is visible to anyone. Use authentication to restrict it to the user who was created first, or implement authorization to restrict it to an administrator. See the "rails-moodle-pundit":https://github.com/RailsApps/rails-moodle-pundit example application if you wish to add authorization.
...
* "Devise and Pundit and Rails":https://github.com/RailsApps/rails-moodle-pundit shows to use Pundit for authorization
...
<pre>
$ git clone git://github.com/RailsApps/rails-moodle.git
</pre>
...
<pre>
$ rails new rails-moodle -m https://raw.github.com/RailsApps/rails-composer/master/composer.rb
</pre>

The @$@ character indicates a shell prompt; don't include it when you run the command.

This creates a new Rails app named @rails-moodle@ on your computer. You can use a different name if you wish.
...
Choose *rails-moodle*. The Rails Composer tool may give you other options (other applications may have been added since these notes were written).
...
Problems? Check the "issues":https://github.com/RailsApps/rails-moodle/issues.

h2. Issues

Please create a "GitHub issue":https://github.com/RailsApps/rails-moodle/issues if you identify any problems or have suggestions for improvements.
...
Send the author a message, create an "issue":https://github.com/RailsApps/rails-moodle/issues, or fork the project and submit a pull request.
...
| "Rails Composer":http://railsapps.github.io/rails-composer/ | "Email and Rails":http://railsapps.github.io/rails-send-email.html | "Devise with RSpec and Cucumber":http://railsapps.github.io/tutorial-rails-moodle-rspec-cucumber.html |
